...
const recommendedArticles: Article[] = [
  {
    ...
    date: 'January 2015',
    imageUrl:
      'https://149909199.v2.pressablecdn.com/wp-content/uploads/2015/01/Edge1.png',
  ...
  },
  {
    ...
    date: 'January 2015',
    imageUrl:
      'https://149909199.v2.pressablecdn.com/wp-content/uploads/2015/01/beam2-1024x836.jpg',
    url: 'https://waitbutwhy.com/2015/01/artificial-intelligence-revolution-2.html',
    description:
      'Part 2 of the exploration into superintelligence and its implications for humanity',
  },
  {
    ...
    description:
      'Brilliant analysis of social networks through the lens of status and social capital',
  },
]
